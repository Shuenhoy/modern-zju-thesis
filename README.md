...
## `bibmode`
目前 `modern-zju-thesis` 使用 https://github.com/Shuenhoy/citext 替代了 Typst 自身的引用功能，实现了双语参考文献等功能，但因使用 QuickJS/WASM，单次编译可能较慢，请充分利用 `typst watch` 或 `tinymist preview` 等增量编译。
